...
static const GOptionEntry options[] = {
  ...
  { "version", 'V', 0, G_OPTION_ARG_NONE, NULL,
    N_ ("Show the applications's version"), NULL },
  { NULL }
};
...
void
load_css_parse_error_signal (GtkCssProvider *provider, GtkCssSection *section,
...
load_css_from_resource (const gchar *filename, gboolean required)
{
  ...
  g_signal_connect (provider, "parsing-error", load_css_parse_error_signal,
                    NULL);
...
static gint
diskey_app_command_line (GApplication *application,
