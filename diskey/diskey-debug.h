...
#define DEBUG_INPUT_LISTENER      DISKEY_DEBUG_INPUT_LISTENER,      __FILE__, __LINE__, G_STRFUNC

void diskey_debug_init(void);
void diskey_debug(DiskeyDebugSection section, const gchar *file, gint line,
                  const gchar *function);
void diskey_debug_message(DiskeyDebugSection section, const gchar *file,
